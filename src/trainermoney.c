...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_VETERAN_F, .multiplier = 8 },
    { .class = TRAINERCLASS_BACKPACKER_F, .multiplier = 8 },
    { .class = TRAINERCLASS_BACKPACKER_M, .multiplier = 8 },
    { .class = TRAINERCLASS_OFFICE_WORKER_F, .multiplier = 8 },
    { .class = TRAINERCLASS_OFFICE_WORKER_M, .multiplier = 8 },
    { .class = TRAINERCLASS_RESEARCHER, .multiplier = 8 },
    { .class = TRAINERCLASS_BUG_MANIAC, .multiplier = 8 },
    { .class = TRAINERCLASS_JR_TRAINER_F, .multiplier = 8 },
    { .class = TRAINERCLASS_JR_TRAINER_M, .multiplier = 8 },
    { .class = TRAINERCLASS_PUNK, .multiplier = 8 },
    { .class = TRAINERCLASS_DELINQUENT, .multiplier = 8 },
    { .class = TRAINERCLASS_GAMBLER, .multiplier = 8 },
    { .class = TRAINERCLASS_TOURIST_F, .multiplier = 8 },
    { .class = TRAINERCLASS_TOURIST_M, .multiplier = 8 },
    { .class = TRAINERCLASS_SIGHTSEER_F, .multiplier = 8 },
    { .class = TRAINERCLASS_SIGHTSEER_M, .multiplier = 8 },
    { .class = TRAINERCLASS_ELITE_ROCKET_F, .multiplier = 8 },
    { .class = TRAINERCLASS_ELITE_ROCKET_M, .multiplier = 8 },
    { .class = TRAINERCLASS_TAMER, .multiplier = 8 },
    { .class = TRAINERCLASS_BIKER_G1, .multiplier = 8 },
    { .class = TRAINERCLASS_KARATE_KING, .multiplier = 8 },
    { .class = TRAINERCLASS_GARY, .multiplier = 8 },
    { .class = TRAINERCLASS_JADE, .multiplier = 8 },
    { .class = TRAINERCLASS_JASPER, .multiplier = 8 },
    { .class = TRAINERCLASS_STEVEN, .multiplier = 8 },
    { .class = TRAINERCLASS_JUAN, .multiplier = 8 },
};
