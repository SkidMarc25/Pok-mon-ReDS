...
const u8 sTrainerGenders[] = {
    ...
    [TRAINERCLASS_PKMN_TRAINER_VETERAN_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_BACKPACKER_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_BACKPACKER_M] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_OFFICE_WORKER_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_OFFICE_WORKER_M] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_RESEARCHER] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_BUG_MANIAC] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_JR_TRAINER_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_JR_TRAINER_M] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_PUNK] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_DELINQUENT] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_GAMBLER] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_TOURIST_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_TOURIST_M] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_SIGHTSEER_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_SIGHTSEER_M] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_ELITE_ROCKET_F] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_ELITE_ROCKET_M] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_TAMER] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_BIKER_G1] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_KARATE_KING] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_GARY] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_JADE] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_JASPER] = TRAINER_MALE,
